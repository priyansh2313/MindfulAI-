			...
			<div className={styles.dashboardPanel}>
				<nav className={styles.dashboardNav}>
					...
					<div className={styles.navButtons}>
						<a  href="https://www.google.com/maps/search/mental+health+professionals+near+me"><button
        ...
        >
          <div className={styles.scrollPanel}>
            ...
            <div className={styles.scrollContent}>
              ...
              <button  className={styles.ctaButton}  onClick={() => navigate("/encyclopedia")}>Learn More</button>
            </div>
          </div>
        </motion.div>
      )}
...
<div className={styles.Reinforcedsection}>
  <div className={styles.ReinforcementHeading}>
    <TrendingUp /> RL Learning Summary
  </div>
  <LearningSummary />
</div>
				...
				<div className={styles.dashboardWidgets}>
					...
					<div className={styles.widgetCard}>
						<p className={styles.widgetHeader}>Which activities helped most when anxious</p>
